          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Add Other Cost</h3>
                ...
                <div className="mt-4 space-y-4">
                  <div>
                    <label htmlFor="cost-description" className="block text-sm font-medium text-gray-700">Description</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label htmlFor="cost-amount" className="block text-sm font-medium text-gray-700">Amount ($)</label>
                    <input 
                      type="text" 
                      name="cost-amount" 
                      id="cost-amount"
